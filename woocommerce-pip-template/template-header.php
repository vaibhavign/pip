...
<head>
	...
	<link href="<?php echo woocommerce_pip_template('uri', 'template.php'); ?>css/woocommerce-pip.css" rel=" stylesheet" type="text/css" media="screen,print" />
        <script type="text/javascript" src="<?php echo WP_PLUGIN_URL  ?>/woocommerce-pip/js/jquery-1.3.2.min.js" ></script>  
        <script type="text/javascript" src="<?php echo WP_PLUGIN_URL  ?>/woocommerce-pip/js/jquery-barcode.js" ></script> 
</head>
